...
print(f"Реальная доля мошеннических транзакций в датасете: {df['class'].mean():.2%}\n")
...
print(f"Средняя доля мошеннических транзакций на таких устройствах: {multi_account_devices['fraud_rate'].mean():.2%}")
print(f"Средняя доля мошеннических транзакций на устройствах с 1 аккаунтом: {device_agg[device_agg['n_users']==1]['fraud_rate'].mean():.2%}")
...
print(f"Средняя доля мошеннических транзакций на таких IP: {multi_account_ips['fraud_rate'].mean():.2%}")
print(f"Средняя доля мошеннических транзакций на IP с 1 аккаунтом: {ip_agg[ip_agg['n_users']==1]['fraud_rate'].mean():.2%}")
...
print(f"Доля мошеннических транзакций среди них:: {quick_signup['class'].mean():.2%}")
print(f"Доля мошеннических транзакций в среднем по датасету: {df['class'].mean():.2%}")
